...
- **سياق طويل جدًا**: يدعم M3 نافذة سياق تصل إلى 512K رمز (tokens)، بينما يدعم M2.7 ما يصل إلى 204,800 رمز، مما يجعله مناسبًا لمعالجة المستندات الطويلة والمحادثات متعددة الأدوار
...
- **النماذج المتاحة**:
  - `MiniMax-M3`: أحدث نموذج رائد، يدعم سياقًا بحجم 512K ومخرجات تصل إلى 128K، كما يدعم إدخال الصور
